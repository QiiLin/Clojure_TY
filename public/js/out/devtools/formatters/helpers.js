...
var G__30713 = devtools.prefs.pref.call(null,v);
v = G__30713;
continue;
} else {
return v;
...
var and__27617__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__27617__auto__){
var and__27617__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__27629__auto__ = (function (){try{if(!((value == null))){
...
}catch (e30716){var _e__29733__auto__ = e30716;
return false;
}})();
if(cljs.core.truth_(or__27629__auto__)){
return or__27629__auto__;
} else {
var or__27629__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e30720){var _e__29733__auto__ = e30720;
return false;
}})();
...
}catch (e30722){var _e__29733__auto__ = e30722;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__27617__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__27617__auto__)){
var and__27617__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__27617__auto____$1){
...
var and__27617__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__27617__auto__)){
...
var or__27629__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__27629__auto__)){
return or__27629__auto__;
} else {
...
var and__27617__auto__ = (function (){var or__27629__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__27629__auto__)){
return or__27629__auto__;
} else {
...
var vec__30724 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__30724,(0),null);
var name = cljs.core.nth.call(null,vec__30724,(1),null);
...
var and__27617__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__27617__auto__)){
...
var or__27629__auto__ = typeof value === 'string';
if(or__27629__auto__){
return or__27629__auto__;
} else {
var or__27629__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__30727_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__30727_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1547003694189