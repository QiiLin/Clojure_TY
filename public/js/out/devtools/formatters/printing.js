...
var len__28754__auto___30742 = arguments.length;
var i__28755__auto___30743 = (0);
while(true){
if((i__28755__auto___30743 < len__28754__auto___30742)){
args__28761__auto__.push((arguments[i__28755__auto___30743]));

var G__30744 = (i__28755__auto___30743 + (1));
i__28755__auto___30743 = G__30744;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__28762__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30739){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__30740,G__30741,seq30739__$2);
});
...
if(cljs.core.truth_((function (){var or__27629__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__28240__auto__,writer__28241__auto__,opt__28242__auto__){
return cljs.core._write.call(null,writer__28241__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__27617__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__27617__auto__){
var or__27629__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__27629__auto__)){
return or__27629__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30745_SHARP_){
return !((cljs.core.meta.call(null,p1__30745_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__30746__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__27629__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e30750){var _e__29733__auto__ = e30750;
return false;
}})();
if(cljs.core.truth_(or__27629__auto__)){
return or__27629__auto__;
...
}catch (e30752){var _e__29733__auto__ = e30752;
return false;
}}
})())){
...
var _STAR_current_state_STAR_30754 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__30755 = opts;
...
var markup_db = cljs.core.get.call(null,map__30755__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_30754;
}});
...
;
var temp__4655__auto___30759 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___30759)){
var managed_print_level_30760 = temp__4655__auto___30759;
var _STAR_print_level_STAR_30758_30761 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_30760;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_30758_30761,managed_print_level_30760,temp__4655__auto___30759,writer,opts,job_fn){
return (function (p1__30757_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__30757_SHARP_,null);
});})(_STAR_print_level_STAR_30758_30761,managed_print_level_30760,temp__4655__auto___30759,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_30758_30761;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1547003694629