...
var len__28754__auto___30733 = arguments.length;
var i__28755__auto___30734 = (0);
while(true){
if((i__28755__auto___30734 < len__28754__auto___30733)){
args__28761__auto__.push((arguments[i__28755__auto___30734]));

var G__30735 = (i__28755__auto___30734 + (1));
i__28755__auto___30734 = G__30735;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28762__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq30731){
var G__30732 = cljs.core.first.call(null,seq30731);
var seq30731__$1 = cljs.core.next.call(null,seq30731);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__30732,seq30731__$1);
});
...
return (p1__30736_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1547003694283