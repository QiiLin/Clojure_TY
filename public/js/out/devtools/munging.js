...
var o30611 = temp__4655__auto__;
var temp__4655__auto____$1 = (o30611["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o30612 = temp__4655__auto____$1;
return (o30612["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29726__auto__ = f;
return (o__29726__auto__["toString"]).call(o__29726__auto__);
} else {
return "";
}
...
return (f[[cljs.core.str.cljs$core$IFn$_invoke$arity$1("cljs$core$IFn$_invoke$arity$"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')]);
});
devtools.munging.get_fn_variadic_arity = (function devtools$munging$get_fn_variadic_arity(f){
return (f[[cljs.core.str.cljs$core$IFn$_invoke$arity$1("cljs$core$IFn$_invoke$arity$variadic")].join('')]);
});
...
try{var o__29726__auto___30615 = t;
(o__29726__auto___30615["cljs$lang$ctorPrWriter"]).call(o__29726__auto___30615,t,writer);
}catch (e30614){var __30616 = e30614;
}
...
var char_code = (function (){var o__29726__auto__ = (new String(char$));
return (o__29726__auto__["charCodeAt"]).call(o__29726__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29726__auto__ = String;
return (o__29726__auto__["fromCharCode"]).call(o__29726__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30617 = num_code;
switch (G__30617) {
case (1):
return (185);
...
var o__29726__auto__ = String;
return (o__29726__auto__["fromCharCode"]).call(o__29726__auto__,superscript_code);
});
/**
...
}catch (e30619){var _e__29733__auto__ = e30619;
return false;
}})())){
...
var vec__30620 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__30620,(0),null);
...
var or__27629__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o30623 = temp__4655__auto__;
var temp__4655__auto____$1 = (o30623["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o30624 = temp__4655__auto____$1;
return (o30624["nameToPath"]);
} else {
return null;
}
} else {
...
var len__28754__auto___30631 = arguments.length;
var i__28755__auto___30632 = (0);
while(true){
if((i__28755__auto___30632 < len__28754__auto___30631)){
args__28761__auto__.push((arguments[i__28755__auto___30632]));

var G__30633 = (i__28755__auto___30632 + (1));
i__28755__auto___30632 = G__30633;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28762__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__30627){
var vec__30628 = p__30627;
var ns_detector = cljs.core.nth.call(null,vec__30628,(0),null);
var effective_detector = (function (){var or__27629__auto__ = ns_detector;
if(cljs.core.truth_(or__27629__auto__)){
return or__27629__auto__;
} else {
...
var G__30634 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__30635 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__30634;
remaining_tokens = G__30635;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30625){
var G__30626 = cljs.core.first.call(null,seq30625);
var seq30625__$1 = cljs.core.next.call(null,seq30625);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__30626,seq30625__$1);
});
...
var vec__30639 = cljs.core.split_with.call(null,(function (p1__30638_SHARP_){
return cljs.core.not_EQ_.call(null,p1__30638_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__30639,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__30639,(1),null);
...
var vec__30642 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__30642,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__30642,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__30645 = cljs.core.rest.call(null,remaining_tokens);
var G__30646 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__30645;
name_tokens = G__30646;
continue;
} else {
...
var vec__30649 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__30649,(0),null);
var arity = cljs.core.nth.call(null,vec__30649,(1),null);
var vec__30652 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__30652,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__30652,(1),null);
var vec__30655 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__30655,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__30655,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__30655,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__30655,(3),null);
...
var vec__30661 = result;
var munged_ns = cljs.core.nth.call(null,vec__30661,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__30661,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__30661,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__30661,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__30661,(4),null);
var arity = cljs.core.nth.call(null,vec__30661,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__30665 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__30665,(0),null);
var args = cljs.core.nth.call(null,vec__30665,(1),null);
var vec__30668 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__30668,(0),null);
var name = cljs.core.nth.call(null,vec__30668,(1),null);
...
var G__30671 = (arity + (1));
var G__30672 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30673){
var vec__30674 = p__30673;
var arity = cljs.core.nth.call(null,vec__30674,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__30674,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__27629__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__27629__auto__)){
return or__27629__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__30677_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__30678_SHARP_);
...
var args__28761__auto__ = [];
var len__28754__auto___30685 = arguments.length;
var i__28755__auto___30686 = (0);
while(true){
if((i__28755__auto___30686 < len__28754__auto___30685)){
args__28761__auto__.push((arguments[i__28755__auto___30686]));

var G__30687 = (i__28755__auto___30686 + (1));
i__28755__auto___30686 = G__30687;
continue;
} else {
}
break;
...
var argseq__28762__auto__ = ((((1) < args__28761__auto__.length))?(new cljs.core.IndexedSeq(args__28761__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28762__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30681){
var vec__30682 = p__30681;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__30682,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30679){
var G__30680 = cljs.core.first.call(null,seq30679);
var seq30679__$1 = cljs.core.next.call(null,seq30679);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__30680,seq30679__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__27629__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__27629__auto__)){
return or__27629__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__27617__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__27629__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__27629__auto__)){
return or__27629__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__30690__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__30690__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__30690__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__30690__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30691 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__30691,(0),null);
var fn_name = cljs.core.nth.call(null,vec__30691,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__30691,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__30691,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__30691,(4),null);
var arity = cljs.core.nth.call(null,vec__30691,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__27617__auto__ = protocol_ns;
if(cljs.core.truth_(and__27617__auto__)){
return cljs.core.not.call(null,(function (){var and__27617__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__27629__auto__ = protocol_part;
if(cljs.core.truth_(or__27629__auto__)){
return or__27629__auto__;
} else {
return fn_part;
...
var o__29726__auto__ = f;
return (o__29726__auto__["getBasis"]).call(o__29726__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__27617__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__27617__auto__)){
...
}catch (e30695){var _e__29733__auto__ = e30695;
...
var G__30696 = (obj[cljs.core.first.call(null,path)]);
var G__30697 = cljs.core.rest.call(null,path);
obj = G__30696;
path = G__30697;
continue;
} else {
...
var partition_bits = (function (){var or__27629__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__27629__auto__)){
return or__27629__auto__;
} else {
return (0);
...
return (function (accum,p__30698){
var vec__30699 = p__30698;
var bit = cljs.core.nth.call(null,vec__30699,(0),null);
var protocol = cljs.core.nth.call(null,vec__30699,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30702){
var vec__30703 = p__30702;
var ns = cljs.core.nth.call(null,vec__30703,(0),null);
var name = cljs.core.nth.call(null,vec__30703,(1),null);
var selector = cljs.core.nth.call(null,vec__30703,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__30708,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__30708,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__30708,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__30706_SHARP_){
return (obj[cljs.core.first.call(null,p1__30706_SHARP_)]);
});})(name,sorted_matches,vec__30708,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1547003693955