...
var or__27629__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj37679 = {"detail":data};
return obj37679;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__27617__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__27617__auto__)){
var and__27617__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__37686 = cljs.core._EQ_;
var expr__37687 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37686.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37687))){
return ((function (pred__37686,expr__37687){
return (function (p1__37680_SHARP_){
return console.warn(p1__37680_SHARP_);
});
;})(pred__37686,expr__37687))
} else {
if(cljs.core.truth_(pred__37686.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37687))){
return ((function (pred__37686,expr__37687){
return (function (p1__37681_SHARP_){
return console.debug(p1__37681_SHARP_);
});
;})(pred__37686,expr__37687))
} else {
if(cljs.core.truth_(pred__37686.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37687))){
return ((function (pred__37686,expr__37687){
return (function (p1__37682_SHARP_){
return console.error(p1__37682_SHARP_);
});
;})(pred__37686,expr__37687))
} else {
return ((function (pred__37686,expr__37687){
return (function (p1__37683_SHARP_){
return console.log(p1__37683_SHARP_);
});
;})(pred__37686,expr__37687))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37690){
...
var opts = map__37691__$1;
var eval_fn = cljs.core.get.call(null,map__37691__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37693_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__37695,(0),null);
var v = cljs.core.nth.call(null,vec__37695,(1),null);
...
if(cljs.core.truth_((function (){var and__27617__auto__ = (typeof localStorage !== 'undefined') && (typeof goog.object.get(localStorage,"getItem") !== 'undefined');
...
//# sourceMappingURL=utils.js.map?rel=1547003710762