...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__28240__auto__,writer__28241__auto__,opt__28242__auto__){
return cljs.core._write.call(null,writer__28241__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__33082 = o;
(G__33082[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__27617__auto__ = !((jsprops == null));
if(and__27617__auto__){
var and__27617__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__33088 = jsprops;
(G__33088["defaultValue"] = value);

(G__33088["onChange"] = ((function (G__33088,v,value,on_change){
return (function (p1__33087_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__33087_SHARP_);
});})(G__33088,v,value,on_change))
);
...
var vec__33091 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__33091,(0),null);
var id = cljs.core.nth.call(null,vec__33091,(1),null);
var class$ = cljs.core.nth.call(null,vec__33091,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___33095 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___33095 == null)){
} else {
var key_33096 = temp__4661__auto___33095;
(jsprops["key"] = key_33096);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__33097 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__33097["name"] = c);
...
var len__28754__auto___33102 = arguments.length;
var i__28755__auto___33103 = (0);
while(true){
if((i__28755__auto___33103 < len__28754__auto___33102)){
args__28761__auto__.push((arguments[i__28755__auto___33103]));

var G__33104 = (i__28755__auto___33103 + (1));
i__28755__auto___33103 = G__33104;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__28762__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq33100){
var G__33101 = cljs.core.first.call(null,seq33100);
var seq33100__$1 = cljs.core.next.call(null,seq33100);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__33101,seq33100__$1);
});
...
break;
default:
var G__33107 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__33107;
continue;
...
var n__28553__auto___33109 = a.length;
var i_33110 = (0);
while(true){
if((i_33110 < n__28553__auto___33109)){
(a[i_33110] = reagent.impl.template.as_element.call(null,(a[i_33110])));

var G__33111 = (i_33110 + (1));
i_33110 = G__33111;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__28553__auto___33112 = a.length;
var i_33113 = (0);
while(true){
if((i_33113 < n__28553__auto___33112)){
var val_33114 = (a[i_33113]);
if((cljs.core.vector_QMARK_.call(null,val_33114)) && ((reagent.impl.template.key_from_vec.call(null,val_33114) == null))){
(o["no-key"] = true);
} else {
}

(a[i_33113] = reagent.impl.template.as_element.call(null,val_33114));
...
var ctx = ({});
var vec__33116 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__33116,(0),null);
var derefed = cljs.core.nth.call(null,vec__33116,(1),null);
...
var G__33119 = (cljs.core.count.call(null,argv) - first_child);
switch (G__33119) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__33119){
...
//# sourceMappingURL=template.js.map?rel=1547003701387